...
exports.copyPediatricWarningScore = (req, res) => {
    ...
    exports.getfistulaGraftSet = (req, res) => {
        ...
        var j = request.jar();
        var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
        const urlEndpoint = String.raw`${baseURL}${config.apiFISTULAGRAFTSRV}/FistulaGraftSet?$filter=(Dockey='${req.query.Dockey}')&$format=json`
        request({
            method: 'GET',
            uri:`${urlEndpoint}`,
            body: req.body,
    ...
    exports.latestDocSet = (req, res) => {
        ...
        var j = request.jar();
        var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
        const urlEndpoint = String.raw`${baseURL}${config.apiFISTULAGRAFTSRV}/LatestDocSet?$filter=Einri='${req.query.einri}' and Falnr = '${req.query.falnr}' and Patnr = '${req.query.patnr}' and Lfdnr = '${req.query.lfdnr}'&$format=json`
        request({
            method: 'GET',
            uri:`${urlEndpoint}`,
            body: req.body,
    ...
    exports.deleteFistulaGraftSet = (req, res) => {
        ...
        request({
            method: 'DELETE',
            uri: baseURL + config.apiFISTULAGRAFTSRV + `/FistulaGraftSet(Dockey='${req.query.Dockey}')`,
            json: true,
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json',
