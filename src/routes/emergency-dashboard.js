...
exports.getSurgicalPassportDoc = (req, res) => {
    ...
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNSURGICALPASSPORTSRV}/LatestDocSet?$filter=Einri eq '${req.query.Einri}' and Falnr eq '${req.query.Falnr}' and Patnr eq '${req.query.Patnr}' and Lfdnr eq '${req.query.Lfdnr}'&$format=json`
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
...
exports.fetchDietMealOrderDetails = (req, res) => {
    ...
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNDIETSRV}/DietOrderSet?$filter=Institution eq '${req.query.einri}' and Caseno eq '${req.query.case}'`;
    console.log(urlEndpoint);
    request({
        method: 'GET',
        uri: urlEndpoint,
