...
exports.createCvcMainDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNCVCMAINTENANCE}/CvcMaintenceSet`
    console.log(urlEndpoint,"createCvcMainDoc");
...
exports.createIntraOpNurRecSetDoc = (req, res) => {
    ...
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNINTRAOPNURRECSRV}/IntraOpNurRecSet`
    console.log(urlEndpoint,"IntraOpNurRecSet");
...
exports.createMewsSetDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNMEWSSRV}/MewsSet`
    console.log(urlEndpoint,"MewsSet");
...
exports.createNurseAssMainDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNNURSERESTRAINTSRV}/NurseRestraintSet`
    request({
        method: 'POST',
        uri:`${urlEndpoint}`,
        body: req.body,
...
exports.createCriticalPainDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNCCPOTSRV}/CcpotSet`
    request({
        method: 'POST',
        uri:`${urlEndpoint}`,
        body: req.body,
...
exports.getCvcMainDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNCVCMAINTENANCE}/LatestDocSet?$filter=Einri eq '${req.body.Einri}' and Falnr eq '${req.body.Falnr}' and Patnr eq '${req.body.Patnr}' and Lfdnr eq '${req.body.Lfdnr}'&$format=json`
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
...
exports.getIntraOpNurRecSetMainDoc = (req, res) => {
    ...
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNINTRAOPNURRECSRV}/LatestDocSet?$filter=Einri eq '${req.body.Einri}' and Falnr eq '${req.body.Falnr}' and Patnr eq '${req.body.Patnr}' and Lfdnr eq '${req.body.Lfdnr}'&$format=json`
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
...
exports.getMewsSetMainDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNMEWSSRV}/LatestDocSet?$filter=Einri eq '${req.body.Einri}' and Falnr eq '${req.body.Falnr}' and Patnr eq '${req.body.Patnr}' and Lfdnr eq '${req.body.Lfdnr}'&$format=json`
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
...
exports.getNurseAssMainDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNNURSERESTRAINTSRV}/LatestDocSet?$filter=Einri eq '${req.body.Einri}' and Falnr eq '${req.body.Falnr}' and Patnr eq '${req.body.Patnr}' and Lfdnr eq '${req.body.Lfdnr}'&$format=json`
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
...
exports.getCriticalPainDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNCCPOTSRV}/LatestDocSet?$filter=Einri eq '${req.body.Einri}' and Falnr eq '${req.body.Falnr}' and Patnr eq '${req.body.Patnr}' and Lfdnr eq '${req.body.Lfdnr}'&$format=json`
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
...
exports.getCvcMainPdf = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const { dockey } = req.query;
    const urlEndpoint = `${baseURL}${config.apiZNCVCMAINTENANCE}/PDFFileSet(Dockey='${dockey}')?$format=json`;
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
        body: req.query,
...
exports.getNurseAssMainPdf = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const { dockey } = req.query;
    const urlEndpoint = `${baseURL}${config.apiZNNURSERESTRAINTSRV}/PDFFileSet(Dockey='${dockey}')?$format=json`;
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
        body: req.query,
...
exports.getNurseIntraPdf = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const { dockey } = req.query;
    const urlEndpoint = `${baseURL}${config.apiZNINTRAOPNURRECSRV}/PDFFileSet(Dockey='${dockey}')?$format=json`;
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
        body: req.query,
...
exports.getMewsSetMainPdf = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const { dockey } = req.query;
    const urlEndpoint = `${baseURL}${config.apiZNMEWSSRV}/PDFFileSet(Dockey='${dockey}')?$format=json`;
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
        body: req.query,
...
exports.getCriticalPainPdf = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const { dockey } = req.query;
    const urlEndpoint = `${baseURL}${config.apiZNCCPOTSRV}/PDFFileSet(Dockey='${dockey}')?$format=json`;
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
        body: req.query,
...
exports.getCvcMainDetail = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNCVCMAINTENANCE}/CvcMaintenceSet?$filter=Dockey eq '${req.query.Dockey}' &$format=json`
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
        body: req.body,
...
exports.getIntraOpNurRecSetDetail = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNINTRAOPNURRECSRV}/IntraOpNurRecSet?$filter=Dockey eq '${req.query.Dockey}'&$expand=TODIAGNOSES,TOSURGICALTEAM,TOPROCEDURE,TOIMPLANTS,TODRAINS,TOPACKS,TOCOUNT,TOSPECIMENS,TOINSTRUMENT_SET&$format=json`
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
        body: req.body,
...
exports.getMewsSetDetail = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNMEWSSRV}/MewsSet?$filter=Dockey eq '${req.query.Dockey}' &$format=json`
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
        body: req.body,
...
exports.mdLoginUser = (req, res) => {   
    const options = {
        url: baseURL  + config.apiZNERADMSRV  + `/UserValidationSet(Uname='${req.query.Uname}',Password='${req.query.Password}')?$format=json`,
        headers: {
            'User-Agent': 'request',
            'spnego': 'disabled',
        ...
        if (error) {
            ...
            for (var i = 0; i < responseCookies.length; i++) {
                ...
                if (oneCookie.indexOf("MYSAPSSO2") != -1) {
                   oneCookie=oneCookie.replace(config.CookieUrlToReplace,config.CookieUrlByReplace);                    
...
exports.getNurseAssMainDetail = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNNURSERESTRAINTSRV}/NurseRestraintSet?$filter=Dockey eq '${req.query.Dockey}'&$expand=TORESTRAINTS&$format=json`
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
        body: req.body,
...
exports.getCriticalPainDetail = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNCCPOTSRV}/CcpotSet?$filter=Dockey eq '${req.query.Dockey}'&$format=json`
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
        body: req.body,
...
exports.ToGetFieldValues  = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNCCPOTSRV}/FieldValuesSet?$filter=Zindicator eq '${req.query.Zindicator}'&$format=json`
    request({
        method: 'GET',
        uri:`${urlEndpoint}`,
        body: req.body,
...
exports.deleteBundlesDoc = (req, res) => {
    ...
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNURINARYCATHETERSRV}/UrinaryCatheterSet(Dockey='${req.query.Dockey}')`
    request({
        method: 'DELETE',
        uri:`${urlEndpoint}`,
        json: true,
...
exports.deleteCvcMainDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNCVCMAINTENANCE}/CvcMaintenceSet(Dockey='${req.query.Dockey}')`
    console.log(urlEndpoint ,"nnccc");
...
exports.deleteMewsSetDoc = (req, res) => {
    ...
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNMEWSSRV}/MewsSet(Dockey='${req.query.Dockey}')`
    console.log(urlEndpoint ,"nnccc");
...
exports.deleteIntraOpNurRecSetDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNINTRAOPNURRECSRV}/IntraOpNurRecSet(Dockey='${req.query.Dockey}')`
    console.log(urlEndpoint ,"deleteIntraOpNurRecSetDoc");
...
exports.deleteNurseAssMainDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNNURSERESTRAINTSRV}/NurseRestraintSet(Dockey='${req.query.Dockey}')`
    console.log(urlEndpoint ,"nnccc");
...
exports.deleteCriticalPainDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNCCPOTSRV}/CcpotSet(Dockey='${req.query.Dockey}')`
    console.log(urlEndpoint ,"nnccc");
...
exports.getPediatricAdmAssesDocDetails = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    const urlEndpoint = `${baseURL}${config.apiZNPAEDIATRICSADMSRV}/PaediatricsAdmSet?$filter=Dockey eq '${req.query.Dockey}'&$expand=TOALLERGY,TOVITALSIGN,TOPHYEXAM,TOVACCINATION,TOINFECTIONS,TOFUNASS,TOADMMED,TOSCALE,TOSURGIHIST,TOFAMILYHIST,TOMEDHIST,TODIAGNOSIS&$format=json`;
...
exports.saveCVCInsertionDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNCVCINSERTIONSRV}/CvcInsertionSet`;
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_CVC_INSERTION_SRV/CvcInsertionSet
    console.log(urlEndpoint);
...
exports.CVCInsertionDocumentLatestDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    const urlEndpoint = `${baseURL}${config.apiZNCVCINSERTIONSRV}/LatestDocSet?$filter=Einri eq '${req.body.Einri}' and Falnr eq '${req.body.Falnr}' and Patnr eq '${req.body.Patnr}' and Lfdnr eq '${req.body.Lfdnr}'&$format=json`;
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_CVC_INSERTION_SRV/LatestDocSet?$filter=Einri eq '1000' and Falnr eq '0000001402' and Patnr eq '0000001101' and Lfdnr eq '00001'&$format=json
    request(
        {
            method: "GET",
            uri: `${urlEndpoint}`,
...
exports.fetcCVCInsertionDocDetails = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    const urlEndpoint = `${baseURL}${config.apiZNCVCINSERTIONSRV}/CvcInsertionSet?$filter=Dockey eq '${req.query.Dockey}' &$format=json`;
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_CVC_INSERTION_SRV/CvcInsertionSet?$filter=Dockey eq 'MED000000000000001000000086500000' &$format=json
    console.log(urlEndpoint);
...
exports.CVCInsertionDocPDF = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNCVCINSERTIONSRV}/PDFFileSet(Dockey='${req.query.Dockey}')?$format=json`;
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_CVC_INSERTION_SRV/PDFFileSet(Dockey='MED000000000000001000000086500000')?$format=json
    request(
        {
            method: "GET",
            uri: `${urlEndpoint}`,
...
exports.deleteCVCInsertionDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNCVCINSERTIONSRV}/CvcInsertionSet(Dockey='${req.query.Dockey}')`;
...
exports.saveFallRiskAssessment = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNFALLRISKPEDSRV}/FallRiskPedSet`;
    console.log(urlEndpoint);
    request({
        method: 'POST',
        uri: urlEndpoint,
...
exports.fallRiskAssessmentLatestDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    const urlEndpoint = `${baseURL}${config.apiZNFALLRISKPEDSRV}/LatestDocSet?$filter=Einri eq '${req.query.Einri}' and Falnr eq '${req.query.Falnr}' and Patnr eq '${req.query.Patnr}' and Lfdnr eq '${req.query.Lfdnr}'&$format=json`;
    console.log(urlEndpoint);
...
exports.getDocFallRiskAssessmentDetails = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNFALLRISKPEDSRV}/FallRiskPedSet?$filter=Dockey eq '${req.query.dockey}' &$format=json`;
    request(
        {
            method: "GET",
            uri: `${urlEndpoint}`,
...
exports.savePatientDelivery = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNPATIENTDELIVERYDETAILSSRV}/PatientDeliverySet`;
    console.log(urlEndpoint);
    request({
        method: 'POST',
        uri: urlEndpoint,
...
exports.fetchPatientDeliveryDetail = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_PATIENT_DELIVERY_DETAILS_SRV/PatientDeliverySet?$filter=Faln1 eq '2201'&$expand=TOPATDEL&$format=json
    const urlEndpoint = `${baseURL}${config.apiZNPATIENTDELIVERYDETAILSSRV}/PatientDeliverySet?$filter=Faln1 eq '${req.query.Faln1}'&$expand=TOPATDEL&$format=json`;
    console.log(urlEndpoint);
...
exports.saveStampDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNMALNUTPAEDIATRICSSRV}/MalnutPaeditricsSet`;
    console.log(urlEndpoint);
    request({
        method: 'POST',
        uri: urlEndpoint,
...
exports.fetchStampDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    const urlEndpoint = `${baseURL}${config.apiZNMALNUTPAEDIATRICSSRV}/MalnutPaeditricsSet?$filter=Dockey eq '${req.query.dockey}' &$expand=TODIAGNOSIS,TONUTRITIONAL,TOWEIGHTHEIGHT,TOVERALLRISK&$format=json`;
    console.log(urlEndpoint);
...
exports.fallStampLatestDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    const urlEndpoint = `${baseURL}${config.apiZNMALNUTPAEDIATRICSSRV}/LatestDocSet?$filter=Einri eq '${req.query.Einri}' and Falnr eq '${req.query.Falnr}' and Patnr eq '${req.query.Patnr}' and Lfdnr eq '${req.query.Lfdnr}'&$format=json`;
    console.log(urlEndpoint);
...
// Attechment Admin
exports.adminAttechmentList = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // http://AMCQAEMR01.ach.jo:8000/sap/opu/odata/sap/ZN_CASEATTACHMENT_SRV/CaseAttachmentSet?$filter=Falnr eq '0000000006'&$format=json   
    const urlEndpoint = `${baseURL}${config.apiZNCASEATTACHMENTSRV}/CaseAttachmentSet?$filter=Falnr eq '${req.query.Falnr}'&$format=json`;
    console.log(urlEndpoint);
...
exports.openAttechmentData = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // /sap/opu/odata/sap/ZN_CASEATTACHMENT_SRV/AttachmentViewSet(Attachment='FOL44000000000004EXT44000000000152',Documenttype='EXT')   
    const urlEndpoint = `${baseURL}${config.apiZNCASEATTACHMENTSRV}/AttachmentViewSet(Attachment='${req.query.attechment}',Documenttype='${req.query.type}')`;
    console.log(urlEndpoint);
...
exports.savePostCareRecord = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_NURSE_OBGY_ASS_SRV/NurseOBGYAssSet
    const urlEndpoint = String.raw`${baseURL}${config.apiZNPOSTANAESTHCARESRV}/PostAnesthCareSet`;
    console.log(urlEndpoint);
    request({
        method: 'POST',
        uri: urlEndpoint,
...
exports.fetchPostCareRecord = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    const urlEndpoint = `${baseURL}${config.apiZNPOSTANAESTHCARESRV}/PostAnesthCareSet?$filter=Dockey eq '${req.query.dockey}' &$expand=TOVITALSIGNOBS,TOMEDICATION,TOINTAKE,TOOUTPUT,TOSCALE&$format=json`;
    console.log(urlEndpoint);
...
exports.PostCareRecordLatestDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_NURSE_OBGY_ASS_SRV/LatestDocSet?$filter=Einri eq '1000' and Falnr eq '0000001402' and Patnr eq '0000001101' and Lfdnr eq '00001'&$format=json
    const urlEndpoint = `${baseURL}${config.apiZNPOSTANAESTHCARESRV}/LatestDocSet?$filter=Einri eq '${req.query.Einri}' and Falnr eq '${req.query.Falnr}' and Patnr eq '${req.query.Patnr}' and Lfdnr eq '${req.query.Lfdnr}'&$format=json`;
    console.log(urlEndpoint);
...
exports.deletePostCareRecordDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // -http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_POST_ANAESTH_CARE_SRV/PostAnesthCareSet(Dockey='MED000000000000001000000092100000')
    const urlEndpoint = String.raw`${baseURL}${config.apiZNPOSTANAESTHCARESRV}/PostAnesthCareSet(Dockey='${req.query.Dockey}')`;
    console.log(urlEndpoint);
...
exports.saveNursingInitialGyno = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_POST_ANAESTH_CARE_SRV/PostAnesthCareSet
    const urlEndpoint = String.raw`${baseURL}${config.apiZNNURSEOBGYASSSRV}/NurseOBGYAssSet`;
    console.log(urlEndpoint);
    request({
        method: 'POST',
        uri: urlEndpoint,
...
exports.fetchNursingInitialGynoDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    const urlEndpoint = `${baseURL}${config.apiZNNURSEOBGYASSSRV}/NurseOBGYAssSet?$filter=Dockey eq '${req.query.dockey}' &$expand=TOALLERGY,TOVITALSIGN,TOMEDICATION,TORISKFACTOR,TOBABY&$format=json`;
    console.log(urlEndpoint);
...
exports.NursingInitialGynoSetLatestDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_NURSE_OBGY_ASS_SRV/LatestDocSet?$filter=Einri eq '1000' and Falnr eq '0000001402' and Patnr eq '0000001101' and Lfdnr eq '00001'&$format=json
    const urlEndpoint = `${baseURL}${config.apiZNNURSEOBGYASSSRV}/LatestDocSet?$filter=Einri eq '${req.query.Einri}' and Falnr eq '${req.query.Falnr}' and Patnr eq '${req.query.Patnr}' and Lfdnr eq '${req.query.Lfdnr}'&$format=json`;
    console.log(urlEndpoint);
...
exports.deleteNursingInitialGynoDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_NURSE_OBGY_ASS_SRV/NurseOBGYAssSet(Dockey='MED000000000000001000000091500000')
    const urlEndpoint = String.raw`${baseURL}${config.apiZNNURSEOBGYASSSRV}/NurseOBGYAssSet(Dockey='${req.query.Dockey}')`;
    console.log(urlEndpoint);
...
exports.getPostCareRecordPdf = (req, res) => {
    console.log(req);
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
...
// OBS FAll Risk Scale
exports.saveObsFallRiskScale = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_FALL_RISK_OBSTETRIC_SRV/FallRiskObsSet
    const urlEndpoint = String.raw`${baseURL}${config.apiZNFALLRISKOBSTETRICSRV}/FallRiskObsSet`;
    console.log(urlEndpoint);
    request({
        method: 'POST',
        uri: urlEndpoint,
...
exports.fetchObsFallRiskScale = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_FALL_RISK_OBSTETRIC_SRV/FallRiskObsSet?$filter=Dockey eq 'SCA000000000000001000000091100000' &$format=json
    const urlEndpoint = `${baseURL}${config.apiZNFALLRISKOBSTETRICSRV}/FallRiskObsSet?$filter=Dockey eq '${req.query.dockey}}' &$format=json`;
    console.log(urlEndpoint);
...
exports.ObsFallRiskScaleLatest = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_APGAR_SCALE_SRV/LatestDocSet?$filter=Einri eq '1000' and Falnr eq '0000001402' and Patnr eq '0000001101' and Lfdnr eq '00001'&$format=json
    const urlEndpoint = `${baseURL}${config.apiZNFALLRISKOBSTETRICSRV}/LatestDocSet?$filter=Einri eq '${req.query.Einri}' and Falnr eq '${req.query.Falnr}' and Patnr eq '${req.query.Patnr}' and Lfdnr eq '${req.query.Lfdnr}'&$format=json`;
    console.log(urlEndpoint);
...
// APGAR Scale
exports.saveDeliveryRecordDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_DELIVERY_RECORD_SRV/DeliveryRecordSet
    const urlEndpoint = String.raw`${baseURL}${config.apiZNDELIVERYRECORDSRV}/DeliveryRecordSet`;
    console.log(urlEndpoint);
    request({
        method: 'POST',
        uri: urlEndpoint,
...
exports.fetchDeliveryRecordDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
...
exports.DeliveryRecordLatestDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_NURSE_OBGY_ASS_SRV/LatestDocSet?$filter=Einri eq '1000' and Falnr eq '0000001402' and Patnr eq '0000001101' and Lfdnr eq '00001'&$format=json
    const urlEndpoint = `${baseURL}${config.apiZNDELIVERYRECORDSRV}/LatestDocSet?$filter=Einri eq '${req.query.Einri}' and Falnr eq '${req.query.Falnr}' and Patnr eq '${req.query.Patnr}' and Lfdnr eq '${req.query.Lfdnr}'&$format=json`;
    console.log(urlEndpoint);
...
exports.deleteDeliveryRecordDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_DELIVERY_RECORD_SRV/DeliveryRecordSet(Dockey='MED000000000000001000000093300000')
    const urlEndpoint = String.raw`${baseURL}${config.apiZNDELIVERYRECORDSRV}/DeliveryRecordSet(Dockey='${req.query.Dockey}')`;
    console.log(urlEndpoint);
...
exports.getDeliveryRecordPDF = (req, res) => {
    console.log(req);
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    ...
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_DELIVERY_RECORD_SRV/PDFFileSet(Dockey='MED000000000000001000000093300000')?$format=json
    const urlEndpoint = String.raw`${baseURL}${config.apiZNDELIVERYRECORDSRV}/PDFFileSet(Dockey='${req.query.dockey}')`
...
// OBS FAll Risk Scale
exports.saveNewBornDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_NIPS_SRV/NIPSSet
    const urlEndpoint = String.raw`${baseURL}${config.apiZNNIPSSRV}/NIPSSet`;
    console.log(urlEndpoint);
    request({
        method: 'POST',
        uri: urlEndpoint,
...
exports.fetchNewbornScaleDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // -http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_NIPS_SRV/NIPSSet?$filter=Dockey eq 'SCA000000000000001000000096100000' &$format=json
    const urlEndpoint = `${baseURL}${config.apiZNNIPSSRV}/NIPSSet?$filter=Dockey eq '${req.query.dockey}}' &$format=json`;
    console.log(urlEndpoint);
...
exports.NewBornScaleLatest = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_APGAR_SCALE_SRV/LatestDocSet?$filter=Einri eq '1000' and Falnr eq '0000001402' and Patnr eq '0000001101' and Lfdnr eq '00001'&$format=json
    const urlEndpoint = `${baseURL}${config.apiZNNIPSSRV}/LatestDocSet?$filter=Einri eq '${req.query.Einri}' and Falnr eq '${req.query.Falnr}' and Patnr eq '${req.query.Patnr}' and Lfdnr eq '${req.query.Lfdnr}'&$format=json`;
    console.log(urlEndpoint);
...
exports.saveConfusionDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_CAM_ICU_SRV/CamIcuSet
    const urlEndpoint = String.raw`${baseURL}${config.apiZNCAMICUSRV}/CamIcuSet`;
    console.log(urlEndpoint);
    request({
        method: 'POST',
        uri: urlEndpoint,
...
exports.fetchConfusionDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_CAM_ICU_SRV/CamIcuSet?$filter=Dockey eq 'SCA000000000000001000000097300000'&$expand=TOSCALE&$format=json
    const urlEndpoint = `${baseURL}${config.apiZNCAMICUSRV}/CamIcuSet?$filter=Dockey eq '${req.query.dockey}'&$expand=TOSCALE&$format=json`;
    console.log(urlEndpoint);
...
exports.ConfusionLatestDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    //http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_CAM_ICU_SRV/LatestDocSet?$filter=Einri eq '1000' and Falnr eq '0000001402' and Patnr eq '0000001101' and Lfdnr eq '00001'&$format=json
    const urlEndpoint = `${baseURL}${config.apiZNCAMICUSRV}/LatestDocSet?$filter=Einri eq '${req.query.Einri}' and Falnr eq '${req.query.Falnr}' and Patnr eq '${req.query.Patnr}' and Lfdnr eq '${req.query.Lfdnr}'&$format=json`;
    console.log(urlEndpoint);
...
exports.saveRichmondScaleDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_RICHMOND_SCALE_SRV/RichmondScaleSet
    const urlEndpoint = String.raw`${baseURL}${config.apiZNRICHMONDSCALESRV}/RichmondScaleSet`;
    console.log(urlEndpoint);
    request({
        method: 'POST',
        uri: urlEndpoint,
...
exports.fetchRichmondDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_RICHMOND_SCALE_SRV/RichmondScaleSet?$filter=Dockey eq 'SCA000000000000001000000097900000'&$format=json
    const urlEndpoint = `${baseURL}${config.apiZNRICHMONDSCALESRV}/RichmondScaleSet?$filter=Dockey eq '${req.query.dockey}'&$format=json`;
    console.log(urlEndpoint);
...
exports.RichmondLatestDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    //http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_CAM_ICU_SRV/LatestDocSet?$filter=Einri eq '1000' and Falnr eq '0000001402' and Patnr eq '0000001101' and Lfdnr eq '00001'&$format=json
    const urlEndpoint = `${baseURL}${config.apiZNRICHMONDSCALESRV}/LatestDocSet?$filter=Einri eq '${req.query.Einri}' and Falnr eq '${req.query.Falnr}' and Patnr eq '${req.query.Patnr}' and Lfdnr eq '${req.query.Lfdnr}'&$format=json`;
    console.log(urlEndpoint);
...
exports.getVacantBedsList = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_CAM_ICU_SRV/CamIcuSet?$filter=Dockey eq 'SCA000000000000001000000097300000'&$expand=TOSCALE&$format=json
    const urlEndpoint = `${baseURL}${config.apiZCVACANTROOMCDS}/ZC_VACANTROOM`;
    console.log(urlEndpoint);
...
exports.getRadiologyWorkList = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);
    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    // /sap/opu/odata/sap/ZN_RADDASHBOARD_SRV/RadListSet?$filter=Facility eq 'XRYSDAMC' and DateFrom eq datetime'2021-01-01T14:14:32' and DateTo eq datetime'2025-06-30T14:14:32' 
    const urlEndpoint = String.raw`${baseURL}${config.apiZNRADDASHBOARDSRV}/RadListSet?$filter=Facility eq 'XRYSDAMC' and DateFrom eq datetime'${req.query.fromDate}' and DateTo eq datetime'${req.query.toDate}'`
    console.log(urlEndpoint);
...
exports.saveRamsayScaleDoc = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_RSS_SRV/RssSet
    const urlEndpoint = String.raw`${baseURL}${config.apiZNRSSSRV}/RssSet`;
    console.log(urlEndpoint);
    request({
        method: 'POST',
        uri: urlEndpoint,
...
exports.fetchRamsayDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
...
exports.RamsayLatestDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
    //http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_CAM_ICU_SRV/LatestDocSet?$filter=Einri eq '1000' and Falnr eq '0000001402' and Patnr eq '0000001101' and Lfdnr eq '00001'&$format=json
    const urlEndpoint = `${baseURL}${config.apiZNRSSSRV}/LatestDocSet?$filter=Einri eq '${req.query.Einri}' and Falnr eq '${req.query.Falnr}' and Patnr eq '${req.query.Patnr}' and Lfdnr eq '${req.query.Lfdnr}'&$format=json`;
    console.log(urlEndpoint);
...
// Labor Room Flow Sheet PMD Document
exports.saveLaborRoomDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies['MYSAPSSO2']);
    let mySAPSSO2Cookie = 'MYSAPSSO2=' + decodeURI(mysapSSO2Value);

    var j = request.jar();
    var cookie = request.cookie('MYSAPSSO2' + '=' + mysapSSO2Value);
    const urlEndpoint = String.raw`${baseURL}${config.apiZNLABORSHEETSRV}/LaborSheetSet`;
    // http://ACHDEVEMR01.ach.jo:0/sap/opu/odata/sap/ZN_LABOR_SHEET_SRV/LaborSheetSet
    console.log(urlEndpoint);
...
exports.deleteLaborRoomDocument = (req, res) => {
    let mysapSSO2Value = decodeURI(req.cookies["MYSAPSSO2"]);
    let mySAPSSO2Cookie = "MYSAPSSO2=" + decodeURI(mysapSSO2Value);
