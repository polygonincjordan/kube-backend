...
router.get("/HemoCatheter", (req,res,next)=>{
    emergencyController.getHemoCatheterDocData(req,res)
})
...
router.post("/savePreCardiacCathDoc", (req, res, next) => {
    emergencyController.savePreCardiacCathDoc(req, res);
});

router.delete("/deletePreCardiacCathDoc", (req, res, next) => {
    emergencyController.deletePreCardiacCathDoc(req, res);
});

router.post("/preCardiacCathLatestDoc", (req, res, next) => {
    emergencyController.preCardiacCathLatestDoc(req, res);
});

router.get("/fetcPreCardiacCathDocDetails", (req, res, next) => {
    emergencyController.fetcPreCardiacCathDocDetails(req, res);
});

router.get("/preCardiacCathDocPDF", (req, res, next) => {
...
// Pre-Cardiac Cath Checklist
router.post("/saveCorrespondenceDocument", (req, res, next) => {
    emergencyController.saveCorrespondenceDocument(req, res);
});

router.delete("/deleteCorrespondenceDocument", (req, res, next) => {
    emergencyController.deleteCorrespondenceDocument(req, res);
});

router.post("/correspondenceSetDocumentLatestDoc", (req, res, next) => {
    emergencyController.correspondenceSetDocumentLatestDoc(req, res);
});

router.get("/fetcCorrespondenceSetDocDetails", (req, res, next) => {
    emergencyController.fetcCorrespondenceSetDocDetails(req, res);
});

router.get("/correspondenceDocPDF", (req, res, next) => {
